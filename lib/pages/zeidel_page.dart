...
class ZeidelPage extends StatefulWidget {
  const ZeidelPage({super.key});

  @override
  State<ZeidelPage> createState() => _ZeidelPageState();
}

class _ZeidelPageState extends State<ZeidelPage> {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: Scaffold(
        ...
        appBar: AppBar(
          title: const Text('МЕТОД ЗЕЙДЕЛЯ'),
          leading: BackButton(
            onPressed: () {
                      ...
                      child: ElevatedButton(
                        onPressed: () {
                          setState(() {
                            ...
                            result = seidel(approx, firstRow, secondRow, thirdRow, b, e);
                          });
                        },
                        child: const Text(
                          'РАССЧИТАТЬ',
